...
This is the one step that isn't a script — it's your judgment call. For every new post, look at its caption and data and produce:
...
- **Who was involved** — people, partners, brands named or tagged, if any (fine to leave empty).
...
For each new post, build a record:
```json
{"id": "...", "url": "...", "posted_at": "...", "caption_excerpt": "...", "media_type": "...", "category": "...", "narrative": "...", "topics": ["..."], "people_partners": ["..."]}
```
Pipe the list of new records for an account into `python3 scripts/append_posts.py <handle>` to merge them into `data/seen_posts.json`.
